import { ConnectButton, useDeploy, useSaleData, useWallet } from '@simpleweb/open-format-react';
      ...
      <main>
        ...
        <div className={styles.main}>
          ...
          <div className={styles.ctaContainer}>
            ...
            <a className={styles.link} href='https://openformat.simpleweb.co.uk/' target="_blank" rel="noopener noreferrer">
              <div className={styles.cta}>
