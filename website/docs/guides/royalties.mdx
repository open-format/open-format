...
One of the features of the open format protocol is the ability to sell and re-sell NFT's on both the primary and secondary marketplace. Creators are able to benefit from sales on the secondary marketplace utilising the Royalty functionality that is baked into the Open Format protocol and therefore the SDK.
